...
jQuery(function () {
    ...
    function format(data) {
        return '<p class="lead" style="margin-left: 25px; float: left; margin-right: 50px;">More Details</p>' +
			   ...
			   '<tr><thead><th style="padding:8px 10px; border: 1px solid #ccc; text-align:center;">Address</th><th style="padding:8px 10px; border: 1px solid #ccc; text-align:center;">Counselor Name</th><th style="padding:8px 10px; border: 1px solid #ccc; text-align:center;">Counselor Contact</th><th style="padding:8px 10px; border: 1px solid #ccc; text-align:center;">Suggested Fees</th></thead></tr>'+
			   
			   
			   
			   '<tr><tbody><td style="padding:8px 10px;overflow:hidden;">'+data[18]+'</td><td style="padding:8px 10px;overflow:hidden;">'+data[16]+'</td><td style="padding:8px 10px;">'+data[17]+'</td><td style="padding:8px 10px;">'+data[14]+'</td></tbody></tr>'+   
 '</table>&hellip;';
