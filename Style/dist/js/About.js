    ...
    function format(data) {
        return '<div class="lead1"></div>' + 
				...
				+  '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"> <div class="lead1" >ID:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[1] +'</div></div>'+ 
                         '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Content:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[2] +'</div></div>'+ 
						 '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Mission:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[3] +'</div></div>'+ 
						 '</div>'+
					    '</section>'
						+'</div>'+
				  ...
				  '<section class="one-half">'
				  +
		             '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Values:</div></div><div class="col-md-8"  style="margin-left:-10%;">' + data[4] +'</div></div>'+ 
						     '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Values:</div></div><div class="col-md-8"  style="margin-left:-10%;">' + data[5] +'</div></div>'+ 
						 '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Image:</div></div><div class="col-md-8"  style="margin-left:-10%;">' + data[6] +'</div></div>'+ 
						 '</div>'+
					    '</section>'+'</div>'+
