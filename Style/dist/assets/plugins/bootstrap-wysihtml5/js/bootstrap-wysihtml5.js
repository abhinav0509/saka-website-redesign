    ...
    var tpl = {
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
                "<a class='btn btn" + size + " btn-default dropdown-toggle' data-toggle='dropdown' href='#'>" +
		...
		"save": function(locale, options) {
            var size = (options && options.size) ? ' btn-'+options.size : '';
            return "<li>" +
                "<div class='btn-group'>" +
                "<a class='btn btn" + size + " btn-default' data-wysihtml5-command='save' title='" + locale.image.insert + "' tabindex='-1'><i class='fa fa-save'></i></a>" +
                "</div>" +
                "</li>";
        }
    };
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
         ...
         save:function(toolbar){
			toolbar.find('a[data-wysihtml5-command=save]').click(function() {
				 if($('#tab2-1').hasClass('active'))
				 {
					 save($('#cont1').val(),'1');
				 }
				  if($('#tab2-2').hasClass('active'))
				 {
					  save($('#cont2').val(),'2');
				 }
				  if($('#tab2-3').hasClass('active'))
				 {
					 save($('#cont3').val(),'3');
				 }
				//	save($('#cont1').val(),'1');															           
