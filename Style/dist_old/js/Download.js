    ...
    function format(data) {
        return '<div class="lead1"></div>' + 
				...
				+  '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"> <div class="lead1" >Name:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[2] +'</div></div>'+ 
                         '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Role:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[4] +'</div></div>'+ 
						 '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Status:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[5] +'</div></div>'+ 
				  ...
				  '<section class="one-half">'
				  +
		             '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Image:</div></div><div class="col-md-8"  style="margin-left:-10%;">' + data[3] +'</div></div>'+ 
