    ...
    function format(data) {
        return '<div class="lead1"></div>' + 
				...
				+  '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"> <div class="lead1" >ID:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[1] +'</div></div>'+ 
                         '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Title:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[2] +'</div></div>'+ 
						 '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Publish Date:</div></div><div class="col-md-8"  style="margin-left:-10%;">' + data[5] +'</div></div>'+ 
				  ...
				  '<section class="one-half">'
				  +
		              '<div class="row" style="margin-bottom:8px;"><div class="col-md-4"><div class="lead1">Description:</div></div><div class="col-md-8" style="margin-left:-10%;">' + data[4] +'</div></div>'+ 
