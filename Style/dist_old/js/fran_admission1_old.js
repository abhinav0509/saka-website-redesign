...
jQuery(function () {
    ...
    function format(data){ 
        ...
        return '<p class="lead" style="margin-left: 25px; float: left; margin-right: 50px;">More Details</p>' +
			   ...
			   '<thead><tr><th style="padding:8px 10px; border: 1px solid #ccc; text-align:center;">Address</th><th style="padding:8px 10px; border: 1px solid #ccc; text-align:center;">Qualification</th><th style="padding:8px 10px; border: 1px solid #ccc; text-align:center;">Exam Date</th></tr></thead>'+
			   '<tbody><tr><td style="padding:8px 10px;overflow:hidden;">'+data[14]+'</td><td style="padding:8px 10px;">'+data[17]+'</td><td style="padding:8px 10px;">'+data[19]+'</td></tr></tbody>'+   
 '</table>&hellip;';
