    ...
    var w = e.document,
            ...
            for (; B < y; B++) {
                ...
                if (!!z && x && !o[z]) {
                    if (A.styleSheet && A.styleSheet.rawCssText) {
                        ...
                        if ((!/^([a-zA-Z:]*\/\/)/.test(z) && !g) || z.replace(RegExp.$1, "").split("http://themes.trendywebstar.com/")[0] === e.location.host) {
                            d.push({
                                href: z,
                                media: C
                            })
        ...
        m = function(I, x, z) {
            var G = I.match(/@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+/gi),
                J = G && G.length || 0,
                x = x.substring(0, x.lastIndexOf("http://themes.trendywebstar.com/")),
                y = function(K) {
