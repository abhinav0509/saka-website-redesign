...
/*----------------------------------------------------------*/
        if ($('.twitter-feeds').length && jQuery()) {
            $.getJSON('twitterc461.html?url=' + encodeURIComponent('statuses/user_timeline.json?screen_name=trendyWebStar&count=1'), function (tweets) { //Put your username here
...
/*----------------------------------------------------------*/
		...
		/////////////////////////////////////////////////////////////////////////////////////////
		   if ($('.flexslider.small').length && jQuery()) {
            var target_flexslider = $('.flexslider.small');
            target_flexslider.flexslider({
                animation: "fade",
                controlNav: false,
				height:100
            });
            $(".flexslider.small").hover(function () {
                    $('.flexslider.small .flex-direction-nav').fadeIn(200);
                },
                function () {
                    $('.flexslider.small .flex-direction-nav').fadeOut(200);
             });
        }
		/////////////////////////////////////////////////////////////////////////////////////////
