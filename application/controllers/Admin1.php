...
EOD;
  ...
  die("asdad");
	...
	public function about()
	{
		$this->load->model('display');
		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/about";
	...
	{
		$this->load->model('display');
        $data1['enquiry']=$this->display->Student_Enquiry_display();
		$data=$this->globaldata;
		$this->load->view('header1',$data);
	...
	public function Slider()
	{
		...
		if($cp!="")
		{
			$this->load->model('display');
			$config=array();
	        $config["base_url"]="http://localhost/CCA/index.php/Admin/Slider";
	...
	public function Testimonial()
	{
		$this->load->model('display');
		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/Testimonial";
    ...
    /*888888888888888888888888888888888888888888888888888888888888888*/
		...
		$this->load->model('display');
 		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/Franchisee";
	...
	public function Book()
	{
	    $this->load->model('display');
		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/Book";
        $config["total_rows"]=$this->display->Book_display();
        $config["per_page"] = 3;
        $config["uri_segment"] = 3;
        $this->pagination->initialize($config);
        $page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
        $data1["results"] = $this->display->Book_Paging($config["per_page"], $page);
        $data1["links"] = $this->pagination->create_links();
	...
	public function Course()
	{
	    $this->load->model('display');
		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/Course";
	...
	public function Order()
	{
		...
		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/Order";
	...
	public function News()
	{
	    $this->load->model('display');
		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/News";
	...
	public function Exam_Module()
	{
        ...
        $config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/Fran_Enquiry";
	...
	public function Placement()
	{
		$this->load->model('display');
		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/Placement";
	...
	public function Download()
	{
		$this->load->model('display');
		$config=array();
        $config["base_url"]="http://localhost/CCA/index.php/Admin/Download";
...
public function Active_Fran()
	{
         ...
         if($pageindex=="")
         {
			...
			$this->load->model('display');
			$config=array();
        	$config["base_url"]="http://localhost/CCA/index.php/Admin/Active_Fran";
...
public function Fran_Admission()
	{
         ...
         if($pageindex=="")
         {
         	...
         	$sname=$this->input->post('cent');
				...
				$config=array();
	        	$config["base_url"]="http://localhost/CCA/index.php/Admin/Fran_Admission";
