...
function Edit(allobj,id)
{
	...
	j('#formVideo').attr('action','<?php echo base_url(); ?>index.php/Set_paper/update_paper');
     var r;
        ...
        j.ajax({  
           ...
           data:{'action':'delabt','id':id},
            ...
            success: function (data) {
                ...
                if(data)
				{
				window.location="<?php echo base_url().'index.php/Admin/Paper'; ?>"
				}
...
<div class="container-fluid-md">
     <div class="row">
         ...
         <form id="hfield" method="post" action="<?php echo base_url(); ?>index.php/Admin/Paper">
         ...
         <form id="formVideo" class="form-horizontal" role="form" action="<?php echo base_url()."index.php/Set_paper/save_paper"; ?>"  enctype="multipart/form-data" method="post" name="frm">
			...
			<div class="col-sm-6" style="margin-top:1%;">
				  ...
				  <div class="form-group">
 					...
 					<div class="form-group">
						 ...
						 <div class="col-sm-8">
						    <input type="text" class="form-control" id="opt3" name="opt3"  title="Please Fill The Option Value">						 
						 </div>
				  </div>
			  ...
			  <div class="form-group">
					    <label class="col-sm-4 control-label" for="inputPassword5">
						 ...
						 <div class="col-sm-8">
						   <input type="text" class="form-control" id="opt4" name="opt4"  title="Please Fill The Option Value">
						 </div>
			  </div>  
