...
<script>
  ...
  function getStud()
  {
            ...
            var op="";
            j.ajax({  
            url: '<?php echo base_url(); ?>index.php/DemoLogin/get_stud_name',
            type: 'POST',
            data:{'action':str},
 ...
 function addnewrow()
 {
  ...
  function getPrice(obj,str,stid)
  {
       ...
       j("#" + tr1).find('#mod').html("");
       j.ajax({  
            url: '<?php echo base_url(); ?>index.php/DemoLogin/get_course_price',
            type: 'POST',
  ...
  function getCourse()
  {
            ...
            var op="";
            j.ajax({  
            url: '<?php echo base_url(); ?>index.php/DemoLogin/get_course_name',
            type: 'POST',
            data:{'action':str},
...
function get_detail_order(dt,id)
{
   ...
   // j("#CancelBtn").show();
    ...
    j('#tdata').empty();
    j.ajax({  
            url: '<?php echo base_url(); ?>index.php/Order_management/get_order_det1',
            type: 'POST',
...
function show(input) {
  ...
  <div class="container-fluid-md">
     ...
     <div class="row">
           ...
           <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody id="vdata" style="font-size:12px;">
                          ...
                          <td><?php echo $ord->Admin_Remark; ?></td>
        ...
        <form id="hfield" action="<?php echo base_url(); ?>index.php/DemoLogin/Book_Order" method="post">
         ...
         <form id="formVideo" class="form-horizontal" action="<?php echo base_url()."index.php/DemoLogin/Insert_order"; ?>"  enctype="multipart/form-data" method="post" name="frm">
          ...
          <tbody id="tdata" style="font-size:12px;">
            ...
            <td>
              <select class="form-control" id="stude" name="stud[]" onchange="check_val(this,this.value)" required title="Select Student Name">
