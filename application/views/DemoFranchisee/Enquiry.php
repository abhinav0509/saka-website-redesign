...
function eachcheck(obj,Status){
  ...
  function clickAction(obj) {
    ...
    if(t!="")
    {
      j('#hfield').attr("action", "<?php echo base_url(); ?>/index.php/DemoNotification/del_Franch_enquiry_by_check?Action="+obj);
      j('#hfield').submit();
    }
    else if(t=="")
    {
              ...
              source: function (request, response) {
                  j.ajax({
                      ...
                      contentType: "application/json; charset=utf-8",
                        url: "<?php echo base_url(); ?>index.php/DemoLogin/GetFranData",
                       data: { term: j("#stu").val()},
                      dataType: "json",
                       success: function (data) {
...
function Download_Excel(id,name)
 {
    ...
    window.location="<?php echo base_url(); ?>index.php/Franchisee/get_single_enquiry_excel1?id="+id+"&"+"name="+name;
 }
 function Download_pdf(id)
 {
   
    window.location="<?php echo base_url(); ?>index.php/Franchisee/get_single_enquiry_pdf1?id="+id;
 }
 ...
 function Download_Excel_all()
 {
    ...
    var stud=j('#stu').val();
   // alert(course);
   window.location="<?php echo base_url(); ?>index.php/Franchisee/get_enquiry_Excell1?fdate="+fdate+"&"+"todate="+todate+"&"+"course="+course+"&"+"stud="+stud
 }
 function Download_pdf_all()
 {
    ...
    var course=j('#cou').val();
    var stud=j('#stu').val();
    window.location="<?php echo base_url(); ?>index.php/Franchisee/get_enquiry_pdf1?fdate="+fdate+"&"+"todate="+todate+"&"+"course="+course+"&"+"stud="+stud
 }

function Edit(obj1,id)	
{
	//alert(id);
	$('form').attr("action", "<?php echo base_url().'index.php/DemoLogin/Update_Active_Enquiry';?>");
...
function Delete(id)
{
    ...
    if (confirm("Are you sure, you want to delete record?"))
        j.ajax({  
            url: '<?php echo base_url(); ?>index.php/DemoLogin/enquiry_del',
            type: 'POST',
           data:{'id':id},
            ...
            success: function (data) {
				...
				window.location="<?php echo base_url().'index.php/DemoLogin/Enquiry'; ?>"
                if(data)
				{
...
<div class="container-fluid-md">
     <div class="row">
      ...
      <div class="row">
             <div class="col-md-12" style="margin-bottom:36px;">
				  ...
				  <div class="row">
                      ...
                      <thead>
                            ...
                            <div class="btn-group btn-group-sm btn-group-text-normal ">
                             <span style="white-space: nowrap; background: #fff none repeat scroll 0 0; padding: 2px 9px 1px 10px;" >
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="javascript:;" onclick="eachcheck(this,'AllNone')">All None</a></li>                                    <li class="divider"></li>
                                    <li>
                          ...
                          <th width="3%" class="thdesign" style="display:none;" >Call Time</th>
          ...
          <form id="hfield" action="<?php echo base_url(); ?>index.php/DemoLogin/Enquiry" method="post">
         ...
         <form id="formVideo" class="form-horizontal" role="form"  action="<?php echo base_url()."index.php/DemoLogin/Daily_Enquiry_Save"; ?>"  enctype="multipart/form-data" method="post" name="frm">
