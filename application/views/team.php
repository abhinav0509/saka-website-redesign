...
<script>
    ...
    j(document).ready(function() {
                    ...
                    reader.onload = function(_file) {
                        ...
                        image.onload = function() {
                            var w = this.width,
                                ...
                                n = file.name,
                                s = ~~(file.size / 1024) + 'KB';
                            if ((h < 300 && w < 300) || (h < 300) || (w < 300)) {
                                alert(n + " File Not Supported. Please Upload Images Within 300px Height and 300px Width.");
                                j('#userfile').val("");
                            }
                        };
            ...
            if (confirm("Are you sure, you want to delete this image?")) {
                j.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data) {
                            window.location = "<?php echo base_url().'index.php/Admin/Team/'; ?>";
                        }
                    },
                    error: function() {
        ...
        window.change_status = function(id, str) {
            j.ajax({
                url: '<?php echo base_url(); ?>index.php/Insert_team/change_status',
                type: 'POST',
                data: { 'str': str, 'id': id },
                success: function(data) {
        ...
        window.Delete = function(id) {
            if (confirm("Are you sure, you want to delete this record?")) {
                j.ajax({
                    url: '<?php echo base_url(); ?>index.php/Insert_team/Delete',
                    type: 'POST',
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav">
                                <li class="active btn btn-success" id="t1"><a href="#tab1-1" data-toggle="tab" style="color: #ffffff;">View Team  <i data-feather="eye"></i></a></li>
                                <li id="t2" class="btn btn-primary" style="margin-left: 10px;"><a href="#tab1-2" data-toggle="tab" style="color: #ffffff;">Add Team <i data-feather="plus"></i></a></li>
                                <li id="t3" class="btn btn-warning" style="margin-left: 10px;"><a href="#tab1-3" data-toggle="tab" style="color: #ffffff;">Edit Team <i data-feather="edit"></i></a></li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab1-1">
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="table-1">
                                            ...
                                            <tbody id="tdata">
                                                <?php if (!empty($team)) { foreach($team as $row) { ?>
                                                <tr>
                                                    <td><?php print $row->id; ?></td>
                                                    <td><?php echo $row->firstname . ' ' . $row->lastname; ?></td>
                                                    <td><?php echo $row->designation; ?></td> 
                                                    <!-- <?php $x = explode(",", $row->image); ?>                                                    -->
                                                    <!-- <td>
                                                        <img src="<?php echo base_url(); ?>uploads/Gallery/<?php echo $x[0]; ?>" style="height:150px; width:150px;border-radius: 5px;">
                                                    </td> -->
                                                    <td style="padding: 9px;"><img src="<?php echo base_url(); ?>uploads/Gallery/<?php echo $row->image; ?>" style="height:150px; width:150px;border-radius: 5px;"></td>
                                                    <td>
                                ...
                                <div class="tab-pane" id="tab1-2">
                                    <h4>Add Team</h4>
                                    <form id="formVideo" action="<?php echo base_url()."index.php/Insert_team/insert"; ?>" method="POST" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <label class="col-md-3">First Name <span class="asterisk">*</span></label>
                                            <div class="col-md-7">
                                                <input type="text" name="firstname" id="firstname" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3">Last Name <span class="asterisk">*</span></label>
                                            <div class="col-md-7">
                                                <input type="text" name="lastname" id="lastname" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-md-3">Designation <span class="asterisk">*</span></label>
                                            <div class="col-md-7">
