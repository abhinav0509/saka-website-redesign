     ...
     <div class="row">
          ...
          <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
                  ...
                  <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
                      <select name="bname" id="bname" class="form-control">                      
                          ...
                          <?php foreach($branch as $b1) { ?>
                          <option value="<?php echo $b1->cus_id; ?>"><?php echo $b1->institute_name; ?></option>
                            <?php } ?>
                      </select>
                  </div>
                    <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
        ...
        <div class="col-md-6">
                   <table id="table1" class="table">
                      <thead>
                          <tr style="background-color:#d7dadc;">
                            <th colspan="3"  class="thdesign">Expense</th>
            ...
            <tbody id="tdata" style="font-size:12px;">
               ...
               <tr>
                ...
                <form id="hfield" name="hfield" method="post" action="<?php echo base_url(); ?>index.php/Admin/Adm_acc_history">
                    ...
                    <input type="hidden" name="bnm" id='bnm' value="<?php echo $dt['bname']; ?>" />
                </form> 
