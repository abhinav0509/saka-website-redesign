...
<head>
    ...
    <title>Project Details | Archipix | Architecture & Interior Design HTML Template</title>
            ...
            <div class="navigation">
                <div class="container">
                    <div class="header-inner-box">
                        ...
                        <a href="index.html" class="logo">Archipix.</a>           

                        <div class="main-menu d-none d-lg-block">
                            <ul>
                                <li><a class="navlink" href="#">Home</a>
                                    <ul class="sub-menu">
                                ...
                                <li class="active"><a class="navlink" href="#">Project</a>
                                    <ul class="sub-menu">
                            ...
                            <div class="mobile-nav-wrap">                    
                                ...
                                <div class="mobile-nav">
                                    ...
                                    <div class="action-bar">
                                        <a href="mailto:info@Archipix.com"><i class="las la-envelope"></i>info@Archipix.com</a>
