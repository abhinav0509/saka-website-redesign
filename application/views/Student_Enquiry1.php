...
{
  j.ajax({
      url: '<?php echo base_url(); ?>index.php/Notifications/set_stud_enq_status',
      type: 'POST',
      data:{'status':"read"},
      success: function (data) {
        if(data)
...
function search_data()
{
            ...
            <div class="tab-content">
			 <div class="tab-pane active" id="tab1-1">
			      ...
			      <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
			      		<input type="text" id="pcont" name="pcont" class="form-control" value="<?php echo $str1; ?>" data-rel="datepicker" placeholder="Search From Date" required/>
				  ...
				  <table class="table table-striped">
                        <thead>
						 ...
						 if(!empty($enquiry)){foreach($enquiry as $row)
						  ...
						  ?>
						  <tr>
						   	<td title="<?php print $row->s_id; ?>"><?php print $row->s_id; ?></td>
  ...
  <form id="hfield" action="<?php echo base_url(); ?>index.php/Admin/Student_Enquiry" method="post">
     ...
     <input type="hidden" name="s" id='s' value="<?php echo $dt['center']; ?>" />
  </form>