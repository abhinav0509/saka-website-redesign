...
function Delete(obj1,id)
{
    if (confirm("Are you sure, you want to Delete It.."))
        j.ajax({  
            url: '<?php echo base_url(); ?>index.php/Admin/Active_stud_Delete',
            type: 'POST',
           data:{'id':id},
      
            success: function (data) {
                alert("Record Deleteted....!");
                if(data)
				        {
           ...
           <div class="col-md-12">
            ...
            <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
                ...
                <thead>
      			...
      			<!--<td  style="text-align:center"><i style="color:#275273;font-size:25px;" id="DeleteN" onclick="Delete(this,<?php echo $row->a_id; ?>);" class="fa fa-trash-o"></i></td>-->
