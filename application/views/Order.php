...
function abc(date1,id1)
{
  ...
  j("#myModal").modal('show');
       ...
       var doc_no=j("#doc_no").val();
       var doc_dt=j("#doc_dt").val();


       j.ajax({  
            url: '<?php echo base_url(); ?>index.php/Order_management/add_ord_remark',
            type: 'POST',
            data:{'remark':remark,'id':id,'dt':dt,'doc_no':doc_no,'doc_dt':doc_dt},
...
function Delete(obj1,date1,id1)
{
  j('#hd3').val(date1);
  j('#hd4').val(id1);
  var dt1=j('#hd3').val();
  ...
  j.ajax({
		...
		url: '<?php echo  base_url();?>index.php/Order_management/Delete_Admin_Order',
		type: 'post',
		 data:{'id':id,'dt1':dt1},
		success: function(data)
		{
			var obj2=j.parseJSON(data);
			alert(obj2.mes);
 ...
 function open_popup(obj1,id)
 {
  ...
  <div class="container-fluid-md">
     ...
     <div class="row">
           <div class="col-md-12">
              <ul class="nav nav-tabs">
                <li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Order</a></li>
                 <li id="t2" class=""><a href="#tab1-2" data-toggle="tab"><i class="fa fa-book"></i>View Detail Order</a></li>
           ...
           <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody id="vdata" style="font-size:12px;">
                          ...
                          <td>       
							<i style="color:#275273;font-size:25px;" id="DeleteN" onclick="Delete(this,'<?php echo $ord->o_date; ?>','<?php echo $ord->f_id; ?>');" class="fa fa-trash-o" title="Delete Record"></i>
        ...
        <div id="Pager1" class="pager" style="display:none">
                                                     ...
                                                     <div class="row" style="width:100%;">
                                                         <div class="col-lg-6">     
                                                             <div class="form-group">
                                                                     ...
                                                                     <input type="text" id="doc_no" name="doc_no" class="form-control" style="width:164px;" placeholder="Docate No"> 
                                                              ...
                                                              <div class="col-md-6"> 
                                                                 <div class="form-group">
                                                                  <div class="input-group date">
                                                                     <input type="text" id="doc_dt" name="doc_dt" data-rel="datepicker" class="form-control" placeholder="Send Date" style="width:140px;">
                                                        ...
                                                        <input type="hidden" id="hd1" name="hd1" value="">
														 ...
														 <input type="hidden" id="hd3" name="hd3" value="">
														 <input type="hidden" id="hd4" name="hd4" value="">
                                                     <div class="row">
