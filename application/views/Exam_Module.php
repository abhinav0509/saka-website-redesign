...
{
  j('#formfrch').attr("action", "<?php echo base_url().'index.php/Exam/update_exam';?>");
        ...
        j.ajax({  
           ...
           data:{'qid':id},
            ...
            success: function (data) {
              ...
              if(data)
              {
                window.location="<?php echo base_url().'index.php/Admin/Exam_Module'; ?>"
              }
     ...
     <div class="row">
           <div class="col-md-12">
              <ul class="nav nav-tabs">
                <li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">Create Exame</a></li>
                <li class="" id="t2"><a href="#tab1-2" data-toggle="tab">View Exame</a></li>
         ...
         <form id="hfield" method="post" action="<?php echo base_url(); ?>index.php/Admin/Exam_Module">
         ...
         <form id="formfrch" class="form-horizontal" action="<?php echo base_url(); ?>index.php/Exam/save_exame"  enctype="multipart/form-data" method="post" name="frm">
