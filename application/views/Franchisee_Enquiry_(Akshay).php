...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="col-lg-6 col-md-6">
          <div class="form-group">
              <label for="signup_pass">District <span class="asterisk">*</span></label>               
              <input type="text" class="form-control" id="dist" pattern="[a-zA-Z ]+" name="dist" placeholder="District" required title="Please enter your District">
          </div>
        </div>
        <div class="col-lg-6 col-md-6">
          <div class="form-group">
