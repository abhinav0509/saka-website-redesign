...
function Delete(obj,id,img)
{
    ...
    if (confirm("Are you sure, you want to Delete It.."))
		...
		j(".dwonload_"+id).remove();
        if(data)
        {
           //j(".downlaod_"+id).remove();
        }
     ...
     <div class="row">
        ...
        <div class="tab-pane active" id="tab1-1">
                      ...
                      <div class="row">
                          <?php if(!empty($result)){ foreach($result as $res){ ?>
                           <?php
                                ...
                                {
                                  $img=base_url()."uploads/corel.jpg";
                                }  
                           ?>
                            <div class="col-sm-6 col-lg-2 dwonload_<?php echo $res['D_id']; ?>">
                                <div class="panel">
                                    <div class="panel-body">
                                        <div class="metric-content metric-icon">
										  <a href="javascript:;" onclick="download_data('<?php echo $res['Image']; ?>')" title="<?php echo $res['Download_Name']; ?>">
											 <img src="<?php echo $img ; ?>" style="height:140px; width:122px; "/>  
										  </a>     
                                      </div>

                                    </div>
                                    <p class="downlaod_title" style="text-align:center;" title="<?php echo $res['Download_Name']; ?>"><?php echo substr($res['Download_Name'],0,20); ?><i style="color:#275273;font-size:16px; margin-left:10px;" id="DeleteN" onclick="Delete(this,'<?php echo $res['D_id']; ?>','<?php echo $res['Image']; ?>');" class="fa fa-trash-o" title="Delete Record"></i></p> 
                                </div>
                            </div>  
            ...
            <div class="tab-pane" id="tab1-2">
                 <form id="hfield" action="<?php echo base_url(); ?>index.php/Admin/Adm_Download" method="post">
         ...
         <form id="formVideo" class="form-horizontal" role="form"  action="<?php echo base_url()."index.php/Download/save_download_data"; ?>"  enctype="multipart/form-data" method="post" name="frm">
