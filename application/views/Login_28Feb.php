 ...
 <div class="container">
    ...
    <center>
       <div style="margin-top:10px;width:45%;">
        <!--<img src="<?php //echo base_url(); ?>Style/images/logo-cca.png" style="margin-top:50px;"/> -->
       </div>
       <div style="border-radius: 7px; width: 60%; height: auto; box-shadow: 0px 3px 10px 3px #434a54; background:#fff; margin-top:30px;">
         <div style="background-color: #ccd0d9; border-top-left-radius: 7px; border-top-right-radius: 7px;padding: 9px;width: 97%;">  
            <span style="color: #4c93ef; font-family: roboto;font-size: 20px">Login</span>
          </div> 
           <br/>
           <div id="form">
            <form class="simple-form" style="width:75%; margin-left:65px;" action="<?php echo base_url();?>index.php/login_cont/check_login" onsubmit="return validate()" method="post">
            <ul>
                ...
                <li>
                  ...
                  <li><span style="color:#F01C2B; display:none; float:left;font-size:14px;" id="passer">Password is required field</span></li>
                    ...
                    <li>
                        <fieldset>
			                       <i class="icon-user tooltip left"></i>
                              <input type="password" name="pass" id="pass" class="text requiredField" title="Password" placeholder="Password" style="width:85%;"/> </fieldset>
                        </fieldset>
                    </li>
                    <li>
              ...
              <fieldset style="border:none;">
                   ...
                   <span style="float:right;"><a href="fpass.php" style="color:#4894C5;">Forgot your password? </a></span>
               </fieldset>
              </li>
        </ul>        
