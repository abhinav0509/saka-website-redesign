...
var mod=j("#modd").val();
 j.ajax({  
            ...
            type: 'POST',
            data:{'estate':estate,'stud_id':'<?php echo $fdata->user_id; ?>','fid':'<?php echo $fdata->f_id; ?>','marks':'<?php echo $correct; ?>','pass_mark':'<?php echo $passmark[0]['pass_marks']; ?>','course':course,'module':mod},
