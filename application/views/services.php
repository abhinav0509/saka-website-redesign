...
<head>
    ...
    <title>Services | Saka India | Architecture & Interior Design HTML Template</title>
...
<body>
                    ...
                    <div class="header-inner-box">
                        ...
                        <div class="main-menu d-none d-lg-block">
                            <ul>
                                ...
                                <li class="active"><a class="navlink" href="#">Pages</a>
                                    <ul class="sub-menu">
    ...
    <!-- Hero Area  -->
    <div id="service_page" class="hero-area mt-30">
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-4 d-none d-md-block order-2 order-lg-1">
                    <img src="assets/img/service/service-feature-img.jpg" alt="">
                </div>
                <div class="col-xl-7 col-lg-7 col-md-8 order-1 order-lg-2">
                    <div class="hero-area-content">
                        <div class="section-title">
                            <span class="meta">Since 2000 <br>Architecture & Interior</span>
                            <h1 class="first_line">Transform</h1>
                            <h1 class="second_line">Your Space</h1>
                            <h1 class="third_line"><i>/</i> with Saka India</h1>
                        </div>
                    </div>
                    <div class="row align-items-end">
                        <div class="col-xl-5 col-lg-5 col-md-6">
                            <img src="assets/img/service/service-feature-img-2.jpg" alt="">
                        </div>
                        <div class="col-xl-7 col-lg-7 col-md-6 d-none d-md-block text-end">
