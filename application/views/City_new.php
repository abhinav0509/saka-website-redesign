                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav">
                                <li class="active btn btn-success" id="t1"><a href="#tab1-1" data-toggle="tab" style="color: #ffffff;">View City <i data-feather="eye"></i></a></li>
                                <li id="t2" class="btn btn-primary" style="margin-left: 10px;"><a href="#tab1-2" data-toggle="tab" style="color: #ffffff;">Add City <i data-feather="plus"></i></a></li>
                            </ul>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="tab-pane active" id="tab1-1">
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="table-1">
                                            ...
                                            <tbody id="tdata">
                                                <?php if (!empty($enquiry2)) { foreach($enquiry2 as $row) { ?>
                                                <tr>
                                                <td><?php print $row->State_Name; ?></td>
                                                <td><?php print $row->City_Name; ?></td>           
                                                   
                                                    <td class="text-center">
                                                        <button class="btn btn-primary btn-action mr-1" data-toggle="tooltip"  onclick="Edit(jArray,<?php echo $row->city_id; ?>);">
                                                            <i class="fas fa-pencil-alt"></i>
                                                        </button>
                                                        <button class="btn btn-danger btn-action" data-toggle="tooltip" onclick="Delete(<?php echo $row->city_id; ?>);">
                                ...
                                <div class="tab-pane" id="tab1-2">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <select class="form-control" id="stat" name="stat" required title="Select State">
                                        ...
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Select District <span class="asterisk">*</span></label>
                                            <div class="col-sm-12 col-md-4">
                                            <input type="text" id="cit" name="cit" class="form-control" placeholder="Select District" required></div>
                                        </div> 
                                        <div class="form-group row mb-4">
                                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Add City <span class="asterisk">*</span></label>
                                            <div class="col-sm-12 col-md-4">
                                            <input type="text" id="cit" name="cit" class="form-control" placeholder="City Name" required></div>
                                        </div> 
