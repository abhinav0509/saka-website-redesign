                                            ...
                                            <tbody id="tdata">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button class="btn btn-primary btn-sm" id="EditB" onclick="Edit(jArray,<?php echo $row->B_id; ?>);">
                                                            <i class="far fa-edit"></i>
                                                        </button>
                                                        <button class="btn btn-danger btn-sm" id="DeleteN" onclick="Delete(<?php echo $row->B_id; ?>);">
