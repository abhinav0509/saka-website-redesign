...
function clickAction(obj) {
    ...
    if(t!="")
    {
      j('#hfield').attr("action", "<?php echo base_url(); ?>/index.php/Notifications/del_admission_from_admin1?Action="+obj);
      j('#hfield').submit();
    }
    else if(t=="")
    {
        ...
        j.ajax({  
           ...
           data:{'action':'delabt','id':id},
            ...
            success: function (data) {
                ...
                if(data)
				{
				window.location="<?php echo base_url().'index.php/Employee/Fran_Admission'; ?>"
				}
...
<div class="container-fluid-md">
    ...
    padding: 2px 9px 1px 10px;" >
         ...
         <form id="hfield" name="hfield" method="post" action="<?php echo base_url(); ?>index.php/Employee/Fran_Admission">
                         ...
                         <div class="row">            
                             ...
                             <div class="col-lg-6" style="background-color:#FFF; margin-left:80px;">               
                                         ...
                                         <div id="LogIn"  class="panel-collapse collapse in" style="border-top: 0px;">
                                                     ...
                                                     <form method="post" id="loginSubmitbtn" action="<?php echo base_url(); ?>index.php/Admission/save_exame_date1">
