     ...
     <div class="row">
           <div class="col-md-12">
              <ul class="nav nav-tabs">
                <li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">Student Result</a></li>
          ...
          ?>
            ...
            <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
             ...
             <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
                     ...
                     <table id="" class="table table-striped" style="float:left;">
                        <thead>
                          ...
                          <th width="5%">Course</th>
            						  ...
            						  <th width="3%">Pass Marks</th>
            						  <th width="3%">Stud Marks</th>
                      ...
                      <tbody id="tdata">
                          ...
                          <tr>
                            <td colspan="9">
                                ...
                                <strong><?php echo "No Todays Exame Record Found.....!";?></strong>
                          </div>
                            </td>
                          </tr>
                          <?php } ?>
               ...
               <form id="hfield" action="<?php echo base_url(); ?>index.php/Employee/Pass_Student" method="post">
