...
function change_status(dt,fid,str)
{
     j.ajax({  
            ...
            success: function (data) {
                 ...
                 if(data)
                 {
                    window.location="<?php echo base_url().'index.php/Employee/Order'; ?>"
                 }
  ...
  <div class="container-fluid-md">
     ...
     <div class="row">
        ...
        <div class="">
         ...
         <form id="hfield" action="<?php echo base_url(); ?>index.php/Employee/Order" method="post">
                         ...
                         <div class="row">            
                             ...
                             <div class="col-lg-6" style="background-color:#FFF;">               
                                         ...
                                         <div id="LogIn"  class="panel-collapse collapse in" style="border-top: 0px;">
                                                     ...
                                                     <form method="post" id="loginSubmitbtn" action="<?php echo base_url(); ?>index.php/Order_management/Add_Remark1">
