...
j("#state1").keypress(function(event){
          ...
          j('#tdata').empty();
           j.ajax({  
            url: '<?php echo base_url(); ?>index.php/Employee/Active_Fran',
            type: 'POST',
        ...
        j.ajax({  
           ...
           data:{'action':'delabt','id':id},
            ...
            success: function (data) {
                ...
                if(data)
				{
				window.location="<?php echo base_url().'index.php/Employee/Active_Fran'; ?>"
				}
...
<div class="container-fluid-md">
     <div class="row">
        ...
        <form id="hfield" action="<?php echo base_url(); ?>index.php/Employee/Active_Fran" method="post">
