...
<div class="container-fluid-md">
     <div class="row">
          ...
          <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
            ...
            <tbody id="tdata" style="font-size:12px;">
                  ...
                  <td title="<?php echo  $row->remark;?>"><?php echo  $row->remark;?></td>
                  				<td><i id="sign" style="font-size:20px; margin-right:10px;" onclick="open_det_popup(jArray,<?php echo $row->id; ?>)" class="fa fa-info-circle"></i><a href="javascript:void(0);" title="Download Pdf"><i class="fa fa-file-pdf-o" onclick="Download_pdf('<?php echo $row->id; ?>')" style="font-size:20px; color:#FF3500;"></i></a><a href="javascript:void(0);" title="Download Excel"><i class="fa fa-file-excel-o" onclick="Download_Excel('<?php echo $row->id; ?>','<?php echo $row->stud_name; ?>')" style="margin-left:3px;font-size:20px;"></i></a><a href="javascript:void(0);"><i class="fa fa-floppy-o" onclick="open_popup(this,'<?php echo $row->id; ?>')" style="margin-left:10px;font-size:20px;"></i></a></td>
		...
		<form id="pfield" action="<?php echo base_url(); ?>index.php/Franchisee/get_pdf_by_cat" method="post">
		...
		<form id="efield" action="<?php echo base_url(); ?>index.php/Franchisee/get_excel_by_cat" method="post">
