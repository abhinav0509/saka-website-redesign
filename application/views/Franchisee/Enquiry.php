...
{
	var name=j("#course").val();
	j.ajax({
			url: '<?php echo  base_url(); ?>index.php/Franchisee/GetModule1',
			type :'POST',
			data: {'cname':name},
     ...
     <div class="row">
      ...
      <div class="row">
          ...
          <form id="hfield" action="<?php echo base_url(); ?>index.php/Franchisee/Daily_Enquiry" method="post">
				...
				<form id="pfield" action="<?php echo base_url(); ?>index.php/Franch_enquiery_excel/get_enquiry_pdf" method="post">
				...
				<form id="efield" action="<?php echo base_url(); ?>index.php/Franch_enquiery_excel/get_enquiry_Excell" method="post">
