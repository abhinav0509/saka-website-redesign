...
echo "<pre>";
$hash = "500dcea0d0a913c71785aaa68f0f2598"."|".urlencode($_POST['account_id'])."|".urlencode($_POST['amount'])."|".urlencode($_POST['reference_no'])."|".$_POST['return_url']."|".urlencode($_POST['mode']);
...
?>
   <div class="textt">
    <center><h3>Redirecting To Payment Page<br></H3>
           <img src="<?php echo base_url(); ?>Style/images/299.gif" style="margin-left:-99px;" />
           <br><span>Please do not refresh the page or do not click on back button</span><br><br><br>
    </center>
  </div>

<form action="https://secure.ebs.in/pg/ma/payment/request" id="payment_form" style="display:none" name="payment" method="POST">
<table>
