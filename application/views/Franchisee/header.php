...
if(isset($userdata->email) && isset($userdata->user_type)!="Admin")
{
     //echo $userdata->type;
}
else
             ...
             <ul class="nav nav-pills nav-stacked" id="Menu">
                     <li class="nav-dropdown" id="home">
			          ...
			          <li class="nav-dropdown" >
						...
						<!--ACCount Menu &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&-->
                        <?php if($userdata->type=="Branch") {?>
                            <li class="nav-dropdown" id="exm_mg">
                                <a href="#" title="Exam Management">
                                    <i class="fa fa-lg fa-fw fa-th-list"></i> Account
                                </a>
                                <ul class="nav-sub">
                                    <li class="nav-dropdown" id="jcard">
                                        <a href="<?php echo  base_url(); ?>index.php/Franchisee/Receipt" title="Receipt">
                                            <i class="fa fa-lg fa-fw fa-file-text"></i>Receipt
                                        </a>
                                    </li>
                                    <li class="nav-dropdown" id="jcard">
                                        <a href="<?php echo base_url(); ?>index.php/Franchisee/Expense" title="Association">
                                            <i class="fa fa-lg fa-fw fa-file-text"></i>Expense
                                        </a>
                                    </li>
                                    <li class="nav-dropdown" id="jcard">
                                        <a href="<?php echo base_url(); ?>index.php/Franchisee/Ac_history" title="Association">
                                            <i class="fa fa-lg fa-fw fa-file-text"></i>Account History
                                        </a>
                                    </li>
                                 </ul>
                        </li>
                        ...
                        <!-- End &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&-->
                     	...
                     	<li class="nav-dropdown" id="exm_mg">
                            ...
                            <ul class="nav-sub">
								 ...
								 <li>
                                    <a href="<?php echo base_url();?>index.php/Franchisee/Pass_Student" title="Exam Module">
