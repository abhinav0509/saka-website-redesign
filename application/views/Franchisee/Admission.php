...
function Download_Excel(id,name)
 ...
 {
    j("#from1").val(j("#cont").val());
    j("#to1").val(j('#pcont').val());
    j("#cr1").val(j('#cou').val());
    j("#st1").val(j('#fran').val());
...
function Edit(obj1,id)
{
    ...
    j('#photo').show();
     ...
     if(obj1[0][r].exame_date)
        edts=obj1[0][r].exame_date.split('-');

     if(edts!="") 
          edt1=edts[2]+"/"+edts[1]+"/"+edts[0];

   if(obj1[0][r].studrel)
      j('#studrel').val(obj1[0][r].studrel); 

   if(obj1[0][r].padd)
      j('#padd').val(obj1[0][r].padd);

   if(obj1[0][r].gender){
      j('input[name="gender"]').each(function(){
           if($(this).val()==obj1[0][r].gender){
   ...
   if(obj1[0][r].dob)
      j('#studdob').val(obj1[0][r].dob);   

   j('#sid').val(obj1[0][r].stud_id); 
   ...
   j('#edt').val(edt1);
   j('#edt').val(obj1[0][r].course_Name);
   j('#hid2').val(obj1[0][r].total_module);
...
function show(input) {
  ...
  function open_det_popup(obj1,id)
 {
     ...
     opt +="<dl class='margin-sm-bottom'><dt><i class=\"fa fa-map-marker\" style='color:#004884;'></i>Present Address</dt><dd>"+obj1[0][r].add+"</dd></dl></div>";
  ...
  <div class="container-fluid-md">
     ...
     <div class="row">
        ...
        <div class="table-responsive">
              <div class="row">
                  <div class="col-md-12" style="margin-bottom:30px;margin-top:-8px;">
                         <?php 
                            $arr1=array();
                            $da1=date('Y/m/d');
                            $arr1 =explode("/",$da1); 
              ...
              <thead>
                <tr style="background-color:#d7dadc;">
                    ...
                    <th width="5%" style="display:none;">Pres. Address</th>
                    <th width="5%" style="display:none;">Perm. Address</th>
                    <th width="5%" style="display:none;">S/o,W/o,D/o</th>
                    <th width="5%" style="display:none;">Gender</th>
                    <th width="5%" style="display:none;">D.O.B</th>
                  ...
                  <td style="display:none;"><?php echo $row->padd; ?></td>
                  <td style="display:none;"><?php echo $row->studrel; ?></td>
             ...
             <?php }?>
                ...
                <div class="tab-pane" id="tab1-2">
				 ...
				 <form id="pfield" action="<?php echo base_url(); ?>index.php/Franch_enquiery_excel/getAdmissioncatpdf" method="post">
                    <input type="hidden" name="from" id='from' value="" />
                    <input type="hidden" name="to" id='to' value="" />
                    <input type="hidden" name="cr" id='cr' value="" />
                    <input type="hidden" name="st" id='st' value="" />
                    <input type="hidden" id="storedArrayvalue" value="" name="storedArrayvalue"/> 
				 </form>
				 
				 <form id="efield" action="<?php echo base_url(); ?>index.php/Franch_enquiery_excel/getfranadmissionexcel" method="post">
                     <input type="hidden" name="from1" id='from1' value="" />
                    <input type="hidden" name="to1" id='to1' value="" />
                    <input type="hidden" name="cr1" id='cr1' value="" />
      ...
      <div class="col-sm-6" style="margin-top:1%;">
       ...
       <input type="hidden" name='max_id' value="<?php echo $max_id; ?>" />
        <div class="form-group">
              <label class="col-sm-4 control-label" for="inputPassword3">Student Reg Id<span class="asterisk">*</span>
                            ...
                            <div class="col-sm-8">
                             <input type="text" id="sid" name="sid" class="form-control" value="<?php echo $id; ?>" readonly required title="Please Enter Student Name" />
                            </div>
        </div>
       ...
       <div class="form-group">
               ...
               <div class="form-group">
                  <label class="col-sm-4 control-label" for="inputPassword3">Gender<span class="asterisk">*</span>
                  </label>
                  <div class="col-sm-4" style="width: 20%; margin-right: 0px;">
                    <input type="radio" id="gender" name="gender" class="form-control" value="Male" style="width: 30%;"/>
                    <span style="display:inline-block;margin-top: -27px;float: right;margin-right: 20px"> Male</span>
                  </div>
                  <div class="col-sm-4" style="width: 20%; margin-left: 0px;">
                    <input type="radio" id="gender" name="gender" class="form-control" value="Female" style="width: 30%;"/>
                    <span style="display:inline-block;margin-top: -27px;float: right;margin-right: 10px;"> Female</span>
                  </div>
               </div>           
               <div class="form-group">
                  <label class="col-sm-4 control-label" for="inputPassword3">S/o,W/o,D/o<span class="asterisk">*</span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" id="studrel" name="studrel" class="form-control" required placeholder="Son Of / Wife Of / Daughter Of" />
                  </div>
              </div>            

               <div class="form-group">
                  <label class="col-sm-4 control-label" for="inputPassword3">D.O.B<span class="asterisk">*</span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" id="studdob" name="studdob" class="form-control" readonly="true" required placeholder="DD/MM/YYYY" />
                  </div>
              </div>     
              ...
              <div class="form-group">
                            <label class="col-sm-4 control-label" for="inputPassword3">Present Address<span class="asterisk">*</span>
                          </label>
                            <div class="col-sm-8">
                             <textarea id="add" name="add" class="form-control" required title="Enter Student Address" style="height: 40px;"/></textarea>
                            </div>
                          </div>

                          <div class="form-group">
                            <label class="col-sm-4 control-label" for="inputPassword3">Permanent Address<span class="asterisk">*</span>
                          </label>
                            <div class="col-sm-8">
                              <textarea id="padd" name="padd" class="form-control" required title="Enter Student Address" style="height: 40px;"/></textarea>
                              <input type="checkbox" name="chkadd" id="chkadd" class="form-control" style="float: left; width: auto;margin-top: -4px;"/>
                              <span class="" style="padding-left: 2px; padding-top: 3px;">Check if address is same as Present address</span>
                            </div>
                          </div>
