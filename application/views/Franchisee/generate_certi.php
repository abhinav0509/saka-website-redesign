              ...
              source: function (request, response) {
                  ...
                  j.ajax({
                     ...
                     // contentType: "application/json; charset=utf-8",
                        url: "<?php echo base_url(); ?>index.php/Franchisee/get_stud_for_certi",
...
function Search_studd1() { 
 ...
 function open_popup(obj1,id)
 {
     ...
     function get_certi_pdf(obj1,course,sid)
     {
       ...
       {
          window.location="<?php echo base_url(); ?>index.php/Franchisee/GetstudCertiPdf?id="+sid+"&"+"course="+course
       }
     }
     ...
     <div class="row">
           <div class="col-md-12">
              <ul class="nav nav-tabs">
                ...
                <li class="" id="t2"><a href="#tab1-2" data-toggle="tab">Certificate History</a></li>
              ...
              <div class="tab-content">		  
                ...
                <div class="tab-pane active" id="tab1-1">
                  <div class="table-responsive">
                    ...
                    <div class="col-sm-2" style="margin-top:0px;margin-bottom:5px;">
                    ...
                    <!--<div style="background-color:#f5f5f5;border-color:#ddd;color:#333;padding: 10px 15px;">
                     ...
                     <table id="" class="table table-striped" style="float:left;">
                        <thead>
                          ...
                          <th width="3%">Student Name</th>
                          <th width="3%">Stud id</th>
						              <th width="5%">Course</th>
                          <th width="3%">Exam Date</th>
                      ...
                      <tbody id="tdata">
                          ...
                          <tr>
                             ...
                             <td>
                              <?php
                                $arr1 =explode("-",$res['exm_date']); 
                                $arr1=array_reverse($arr1);
                                $newtdate1 =implode($arr1,"-");                                
                                echo $newtdate1;
                               ?>
                             </td>                          
                         ...
                         <td><i class="fa fa-certificate" title="Download Certificate" onclick="get_certi_pdf(this,'<?php echo $res['course_Name']; ?>','<?php echo $res['stud_id']; ?>')" style="margin-left:10px; color:e13042; font-size:20px;"></i></td>
                          </tr>
                          <?php } } else { ?>
            ...
            <div class="panel panel-metric panel-metric-sm">
                <div class="panel-body panel-body-primary">
                    <div class="metric-content metric-icon">
                        ...
                        <header>
                            <h3 class="thin">Toal Admissions</h3>
                        </header>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-metric panel-metric-sm">
                <div class="panel-body panel-body-primary">
                    <div class="metric-content metric-icon">
                        ...
                        <header>
                            <h3 class="thin">Toal Certificates</h3>
                        </header>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-metric panel-metric-sm">
                <div class="panel-body panel-body-primary">
                    <div class="metric-content metric-icon">
                        ...
                        <header>
                            <h3 class="thin">Issued Certificates</h3>
                        </header>
                    </div>
                </div>
            </div>
                    ...
                    <div class="metric-content metric-icon">
                        <div class="value">
                          <?php $tot=0; ?>
                           ...
                           ?>
                           <?php
                           if(!empty($issued_certi) && !empty($tot_orders)){
                            echo $tot=intval($total-$issued); 
                          }
                          else{
                          echo $tot;
                        }
                        ...
                        <header>
                            <h3 class="thin">Pending Certificates</h3>
                        </header>
                    </div>
                </div>
            </div>
