...
table tbody td:hover{cursor: pointer;}
       ...
       j("#stud").autocomplete({
              source: function (request, response) {
                  j.ajax({
                      type: "POST",
                      //contentType: "application/json; charset=utf-8",
                        url: "<?php echo base_url(); ?>index.php/Admin/getExmStude1",
     ...
     <div class="row">
         ...
         <!--   <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
             ...
             <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
                     ...
                     <table id="" class="table table-striped" style="float:left;">
                      ...
                      <tbody id="tdata">
                          ...
                          <tr>
                             ...
                             <td title="<?php echo $res['exm_date']; ?>"><?php echo $res['exm_date']; ?></td>
                             <td title="<?php echo $res['course']; ?>"><?php echo $res['course']; ?></td>
                             <td title="<?php echo $res['module']; ?>"><?php echo $res['module']; ?></td>
                             <td title="<?php echo $res['p_mark']; ?>"><?php echo $res['p_mark']; ?></td>
                             <td title="<?php echo $res['marks']; ?>"><?php echo $res['marks']; ?></td>
                             <td title="<?php echo $res['status']; ?>"><?php echo $res['status']; ?></td>
               ...
               <form id="hfield" action="<?php echo base_url(); ?>index.php/Franchisee/Pass_Student" method="post">
