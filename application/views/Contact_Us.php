...
function Edit(obj1,id)
{
    ...
    j("#tab1-2").addClass("active");
	 ...
	 $('#type').val(obj1[0][r].ftype);
	 $('#name').val(obj1[0][r].fname);
     $('#add').val(obj1[0][r].Addd);
                   ...
                   <table class="table">
                      <thead>
                        <tr style="background-color:#d7dadc;">                          
						  <th width="10%">Franchisee Type</th>
					...
					foreach($enquiry as $row)
					  ...
					  ?>
					  <tr>					  
					  <td><?php print $row->ftype;
						/*if($row->ftype=="Our Franchisee")
						{
							echo "Our Franchisee";
						}
						else
						{
							echo "Associate Franchise Partner";
						}*/
					  
					  ?></td>
					  <td><?php print $row->fname; ?></td>
					  <td><?php print $row->Addd; ?></td>
			...
			<form id="formVideo" class="form-horizontal" role="form" action="<?php echo base_url()."index.php/Contact/Insert"; ?>"  enctype="multipart/form-data" method="post" name="frm">
				...
				<div class="col-sm-6" style="margin-top:1%;">
					<div class="form-group">
						<label class="col-sm-4 control-label" for="inputPassword3">Select Franchisee Type<span class="asterisk">*</span>
						</label>
						<div class="col-sm-8">
						 <select name="type" id="type" class="form-control" required>
							<option value="">Select Franchisee Type</option>
							<option value="Our Own Franchisee">Our Own Franchisee</option>
							<option value="Associate Franchise Partner">Associate Franchise Partner</option>
						 </select>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-4 control-label" for="inputPassword3">Franchise Name<span class="asterisk">*</span>
						</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
						 <input type="text" id="cont" name="cont" class="form-control cont" maxsize="10" required/>
						</div>
					</div> 
					<div class="form-group">
						...
						<div class="col-sm-8">
						 <input type="email" id="eml" name="eml" class="form-control" />
						</div>
					</div>
				</div>
				<div class="panel-footer">
				<div class="form-group">
					<div class="col-sm-offset-4 col-sm-8">
					  <input class="btn btn-primary" type="submit" value="Save" name="save" id="SaveBtn" onclick="return validate()"/>
					  <input class="btn btn-primary " id="UpdateBtn" type="submit" style=" display:none;" value="Update" name="update" onclick="return validate()"/>
