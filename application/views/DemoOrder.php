     ...
     j("#rmd").click(function(){
      ...
      remark=j("#msg").val();
       j.ajax({  
            ...
            url: '<?php echo base_url(); ?>index.php/DemoLogin/Admin_Remark1',
			type: "POST",
  ...
  <div class="container-fluid-md">
     ...
     <div class="row">
        ...
        <div class="">
           ...
           <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody id="vdata" style="font-size:12px;">
                          ...
                          <td>
                           <i class="fa fa-floppy-o" id="signe" data-toggle="modal" onClick="abc('<?php echo $ord->o_date; ?>','<?php echo $ord->f_id; ?>')" style="margin-left:10px;font-size:20px;color:#FF3500;margin-right:10px;" title="Add Remark"></i> 
                           
                          <a href="javascript:void(0);" onClick="get_order_det_admin('<?php echo $ord->o_date; ?>','<?php echo $ord->f_id; ?>')" title="View Detailed Order"><i class="fa fa-credit-card" style="font-size:20px;"></i></a>
         ...
         <form id="hfield" action="<?php echo base_url(); ?>index.php/Admin/Demo_Order" method="post">
                         ...
                         <div class="row">            
                             ...
                             <div class="col-lg-6" style="background-color:#FFF;">               
                                         ...
                                         <div id="LogIn"  class="panel-collapse collapse in" style="border-top: 0px;">
                                                     ...
                                                     <form method="post" id="loginSubmitbtn" action="<?php echo base_url(); ?>index.php/DemoLogin/Add_Remark2">
                                                     ...
                                                     <div class="row">
                                                         <div class="col-lg-12 form-group">                                    
                                                             <button class="btn btn-primary btn-block login-social" type="submit">Save Remark</button>                                    
                                                         </div>
                                                     </div>
                                                     </form>
