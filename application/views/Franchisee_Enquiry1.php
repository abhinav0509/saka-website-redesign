...
{
  j.ajax({
      url: '<?php echo base_url(); ?>index.php/Notifications/set_fran_enq_status',
      type: 'POST',
      data:{'status':"read"},
      success: function (data) {
        if(data)
    ...
    if (confirm("Are you sure, you want to"))
        ...
        success: function (data) {
                ...
                alert(obj.message);
                 if(data)
          				{
          				window.location="<?php echo base_url().'index.php/Admin/Fran_Enquiry'; ?>"
          				}
     ...
     <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs">
               ...
               <!--<li class="#" id="t2"><a href="#tab1-2" data-toggle="tab">Add Franchisee</a></li>-->
            </ul>
          ...
          <?php }?>
              ...
              <form id="hfield" action="<?php echo base_url()."index.php/Admin/Fran_Enquiry"; ?>" method="post">
