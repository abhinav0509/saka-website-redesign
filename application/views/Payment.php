     ...
     <div class="row">
           <div class="col-md-12">
              <ul class="nav nav-tabs">
                <li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View Payment</a></li>
        ...
        <div class="">
                    ...
                    <table class="table">
                      <thead>
                        <tr style="background-color:#d7dadc;">
						 ...
						 <th width="25%">Franchisee Name</th>
                      ...
                      <tbody id="vdata" style="font-size:12px;">
						  ...
						  <td title="<?php echo $ord->fname; ?>"><?php echo $ord->fname; ?></td>
						 <td title="<?php echo $ord->amount; ?>"><?php echo $ord->amount; ?></td>
						 <td><a href="<?php echo base_url();?>/uploads/Receipt/<?php echo $ord->receipt; ?>" download><img src="<?php echo base_url();?>/uploads/Receipt/<?php echo $ord->receipt; ?> " style="height:115px; width:192px;"></a></td>
                          <?php } }else{ ?>        
                         <tr>
         ...
         <form id="hfield" action="<?php echo base_url(); ?>index.php/Admin/Payment_History" method="post">
