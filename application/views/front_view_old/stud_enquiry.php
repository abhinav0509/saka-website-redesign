                ...
                <div class="contact-page-content">
                    ...
                    <div class="contact-form clearfix">
                       ...
                       <!-- <p class="full-row"> 
                        ...
                        <p class="full-row">
                            <span class="contact-label">
                                <label for="email-id">Interesed Course:</label><span style="margin-left:10px; color:red;font-size:12px; ">*</span>
                            </span>
                          <select class="searchselect" id="cour" name="cour" required>
