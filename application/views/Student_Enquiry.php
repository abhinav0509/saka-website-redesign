...
function clickAction(obj) {
    ...
    if(t!="")
    {
      j('#hfield').attr("action", "<?php echo base_url(); ?>/index.php/Notifications/saveFronstudenq?Action="+obj);
      j('#hfield').submit();
    }
    else if(t=="")
    {
...
function search_data()
{
   ...
   <form id="hfield" method="post" action="<?php echo base_url(); ?>index.php/Admin/Student_Enquiry">
