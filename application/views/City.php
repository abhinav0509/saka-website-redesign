...
//alert(id);
    if (confirm("Are you sure, you want to Delete It.."))
        j.ajax({  
            url: '<?php echo base_url(); ?>index.php/AddCity/Delete',
            type: 'POST',
           data:{'action':'delbook','id':id},
            ...
            success: function (data) {
                 if(data)
				{
				window.location="<?php echo base_url().'index.php/Admin/city1'; ?>"
				}
...
function Edit(obj1,id)
{
    ...
    j("#tab1-2").addClass("active");
     ...
     var r;
      ...
      {
         if(obj1[0][i].city_id==id)
         {
          r=i;
         }	
      }
	  //alert(obj1[0][r].name);
	 j('#cit').val(obj1[0][r].name);
     ...
     <div class="row">
           <div class="col-md-12">
              <ul class="nav nav-tabs">
                <li class="active" id="t1"><a href="#tab1-1" data-toggle="tab">View City</a></li>
                <li id="t2" class=""><a href="#tab1-2" data-toggle="tab"><i class="fa fa-book"></i>Add City</a></li>
            ...
            <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
                ...
                <thead>
                    <tr style="background-color:#d7dadc;">
						...
						<script>
                            var jArray=[];
                           jArray.push(<?php echo json_encode($enquiry2); ?>);
						</script>
						 <tbody id="tdata" style="font-size:12px;">
						<?php		
						if(!empty($enquiry2)) { foreach($enquiry2 as $row)
						{ ?>
						<tr>
						...
						<td style="text-align:center"><i style="color:#275273;font-size:25px;" id="EditB" onclick="Edit(jArray,<?php echo $row->city_id; ?>);" class="fa fa-edit"></i></td>
      			<td  style="text-align:center"><i style="color:#275273;font-size:25px;" id="DeleteN" onclick="Delete(<?php echo $row->city_id; ?>);" class="fa fa-trash-o"></i></td>
      			</tr>	
              	<?php } } else{ ?>
             <tr>
                <td colspan="9">
          ...
          <form id="hfield" action="<?php echo base_url(); ?>index.php/Admin/city1" method="post">
					...
					<input type="hidden" name="st1" id='st1' value="<?php echo $dt['st_name']; ?>" />
                    <input type="hidden" name="ct1" id='ct1' value="<?php echo $dt['ct_name']; ?>" />
               </form> 


         <form id="formVideo" class="form-horizontal" role="form" action="<?php echo base_url()."index.php/AddCity/Insert"; ?>"  enctype="multipart/form-data" method="post" name="frm">
         ...
         <div class="panel panel-body" style="border:1px solid #CCC;">
					<div class="col-sm-6" style="margin-top:1%;">
						   ...
						   <input type="hidden" id="bid" name="bid" value="" />
                            ...
                            <label class="col-sm-4 control-label" for="inputPassword3">Select State<span class="asterisk">*</span>
                          </label>
                            <div class="col-sm-8">
                             <select id="stat" name="stat" class="form-control">
                             <option value="">Select State</option>
                             <?php foreach($enquiry1 as $row)
							 {
                          ...
                          <input type="hidden" name="bnm" id='bnm' value="<?php //echo $row['state_id']; ?>" />
                          
                          <div class="form-group">
                            <label class="col-sm-4 control-label" for="inputPassword3">Select District<span class="asterisk">*</span>
                          </label>
                            <div class="col-sm-8">
                             <input type="text" id="cit" name="cit" class="form-control" placeholder="Select District" required/>
                            </div>
                          </div>
                          
                          <div class="form-group">
                            <label class="col-sm-4 control-label" for="inputPassword3">Add City<span class="asterisk">*</span>
                          </label>
                            <div class="col-sm-8">
                             <input type="text" id="cit" name="cit" class="form-control" placeholder="City Name" required/>
                            </div>
                          </div>
