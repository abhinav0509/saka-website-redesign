    ...
    <center>
       ...
       <div style="border-radius: 7px; width: 60%; height: auto; box-shadow: 0px 3px 10px 3px #434a54; background:#fff; margin-top:30px;">
         <div style="background-color: #ccd0d9; border-top-left-radius: 7px; border-top-right-radius: 7px;padding: 9px;width: 97%;">  
            <span style="color: #4c93ef; font-family: roboto;font-size: 20px"> Franchisee Login</span>
          </div> 
           <br/>
           <div id="form">
            <form class="simple-form" style="width:75%; margin-left:65px;" action="<?php echo base_url();?>index.php/login_cont/Franchisee_Login" onsubmit="return validate()" method="post">
            <ul>
             ...
             <li>&nbsp;</li>
              ...
              <fieldset>
			   <i class="icon-user tooltip left"></i>
                <input type="password" name="Password" id="pass" class="text requiredField" title="Password" placeholder="Password" style="width:85%;"/> </fieldset></li>
                  <li>
