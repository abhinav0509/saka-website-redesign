<script type="text/javascript" src="<?php echo base_url(); ?>Style/js/jssor.js"></script>
<script type="text/javascript" src="<?php echo base_url(); ?>Style/js/jssor.slider.js"></script>
...
<style>
.lms_page_title .lms_page_title_bg { min-height: 170px; }
</style>
...
<script>
 jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.max(Math.min(parentWidth, 1160), 300));
                else
  ...
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
      <div class="lms_title_center">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="course-post">
                           <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 1141px;
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 240px; top: 0px; width: 920px; height: 480px; overflow: hidden;">
    <?php if(!empty($results)) { foreach($results as $row) 
          ...
          <?php 
            ...
            ?>    
       <div>
                <img u="image" src="<?php echo base_url(); ?>uploads/Gallery/<?php echo $x[$i]; ?>" style="height:99px width:99px;" />
                <img u="thumb" src="<?php echo base_url(); ?>uploads/Gallery/<?php echo $x[$i]; ?>"  style="height:300px width:720px;"/>
            </div>
    <?php } } ?>
        </div>
        ...
        <style>
            ...
            */
            .jssora05l, .jssora05r {
                ...
                height: 40px;
                cursor: pointer;
                background: url('<?php echo base_url(); ?>uploads/a17.png') no-repeat;
                overflow: hidden;
            }
            ...
            */
            ...
            .jssort02 {
                ...
                .jssort02 .c {
                    ...
                    background: url('<?php echo base_url(); ?>uploads/t01.png') -800px -800px no-repeat;
                    _background: none;
                }
