...
<meta name="description"  content="Collage Of Computer Accountants"/>
<meta name="keywords" content="Collage Of Computer Accountants">
<meta name="author"  content="Collage Of Computer Accountants"/>
...
<title>Collage Of Computer Accountants</title>
...
.mega-menu-sub-title{color:#FF9933;}
</style>
...
<header id="lms_header">
  <div class="container">
    <h1 class="logo"> <a href="<?php echo base_url();?>"> <img alt="Porto" width="71" height="60" data-sticky-width="82" data-sticky-height="40" src="<?php echo base_url();?>Style/images/logo.png"> </a> </h1>
      ...
      <nav class="nav-main mega-menu">
        <ul class="nav nav-pills nav-main" id="mainMenu">
              ...
              <li>
                <div class="mega-menu-content">
                  <div class="row">
                    <div class="col-md-3">
                      <ul class="sub-menu">
                        <li> <span class="mega-menu-sub-title" style='color:#FF9933;'>Tally ERP9</span>
                          <ul class="sub-menu">
                    ...
                    <div class="col-md-3">
                      <ul class="sub-menu">
                        <li> <span class="mega-menu-sub-title" style='color:#FF9933;'>Microsoft Excel 2010</span>
                          <ul class="sub-menu">
                    ...
                    <div class="col-md-3">
                      <ul class="sub-menu">
                      <li><span class="mega-menu-sub-title" style='color:#FF9933;'>Certified e-Accountant</span>
                      <ul class="sub-menu">
                    ...
                    <div class="col-md-3">
                      <ul class="sub-menu">
                        <li> <span class="mega-menu-sub-title" style='color:#FF9933;'>Other Courses</span>
                          <ul class="sub-menu">
          ...
          <li class="dropdown"> <a class="dropdown-toggle"> CCA Brands <i class="icon icon-angle-down"></i> </a>
            <ul class="dropdown-menu">
             <li><a href="<?php echo base_url();?>index.php/welcome/cca_skills"><i class="icon-cog"></i>CCA Skills</a></li>
						<li><a href="<?php echo base_url();?>index.php/welcome/franchisee"><i class="icon-group"></i>CCA Franchise</a></li>
						<li><a href="<?php echo base_url();?>index.php/welcome/institute"><i class="icon-building"></i>CCA Group Of Institutes</a></li>
						<li><a href="<?php echo base_url();?>index.php/welcome/cca_college"><i class="icon-building"></i>CCA Colleges</a></li>
            </ul>
          </li>
