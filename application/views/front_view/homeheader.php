...
<head>
      ...
      <link rel="icon" href="<?php echo base_url();?>uploads/Slider/niper.jpg">
      <title>National Institute of Pharmaceutical Education and Research (NIPER) - Ahmedabad</title>
      <!-- CSS FILES START -->
      <link href="<?php echo base_url();?>data/css/custom.css" rel="stylesheet">
      <link href="<?php echo base_url();?>data/css/color.css" rel="stylesheet">
      <link href="<?php echo base_url();?>data/css/responsive.css" rel="stylesheet">
      <link href="<?php echo base_url();?>data/css/owl.carousel.min.css" rel="stylesheet">
      <link href="<?php echo base_url();?>data/css/bootstrap.min.css" rel="stylesheet">
      <link href="<?php echo base_url();?>data/css/prettyPhoto.css" rel="stylesheet">
      <link href="<?php echo base_url();?>data/css/all.min.css" rel="stylesheet">
      <!-- CSS FILES End -->
   </head>
   <body>
         ...
         <header class="header-style-3 wf100">
            <div class="topbar">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                     <p><i class="fa fa-phone"></i> +91 87 930 930 20 / info@gmail.com</p>
                           <!-- <p><i class="fas fa-envelope"></i> info@gmail.com</p> -->
                     </div>
                     <div class="col-md-6">
                        <ul class="topbar-social">
                           <li class="social-links"> <a href="#"><i class="fab fa-facebook-f"></i></a> <a href="#"><i class="fab fa-twitter"></i></a> <a href="#"><i class="fab fa-linkedin-in"></i></a> <a href="#"><i class="fab fa-google-plus-g"></i></a> <a href="#"><i class="fab fa-instagram"></i></a> <a href="#"><i class="fab fa-youtube"></i></a> </li>
                           <li> <a class="acclink" href="<?php echo base_url()?>index.php/Admin" target="_blank"><i class="far fa-user-circle"></i> Login</a> </li>
                        </ul>
                     </div>
                  </div>
               </div>
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-md-6 col-sm-4">
                        <div class="logo"><a href="index-2.html"><img src="<?php echo base_url();?>data/images/logo.jpg" alt="" style="margin-left: -19px;height:66px;"></a></div>
                     </div>
                     <!-- <div class="col-md-4 col-sm-8">
                        <ul class="header-contact">
                           <li><i class="fas fa-phone"></i> +91 87 930 930 20</li>
                           <li><i class="fas fa-envelope"></i> info@gmail.com</li>
                        </ul>
                     </div> -->
                     <div class="col-md-6 col-sm-12">
                        <a class="con-btn" href="#">Test</a>
