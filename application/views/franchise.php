...
function Edit(obj1,id)
{
  ...
  j('#formfrch').attr("action", "<?php echo base_url().'index.php/Admin_Franch/update_fran';?>");
   ...
   $('#fname').after("<input type='hidden' id='cid' value='" + obj1[0][r].city + "' name='cid'/>"); 
    ...
    j('#ftype option').each(function () {
       if (j(this).val() == obj1[0][r].type) {
            j(this).attr('selected', 'selected');
          }
    }); 
 }  
...
function clickAction(obj) {
    ...
    if(t!="")
    {
      j('#hfield').attr("action", "<?php echo base_url(); ?>/index.php/Admin/Savebatchdata?Action="+obj);
      j('#hfield').submit();
    }
    else if(t=="")
    {
...
function getsingleExcel(id,name)
{
 ...
 function open_popup(obj1,id)
 {
     ...
     opt +="<div class='col-sm-7 profile-details'><h3><i class=\"fa fa-institution\" style='color:#FFF;'></i>" +obj1[0][r].institute_name+"</h3>";
     opt +="<h4 class='thin'><i class=\"fa fa-globe\" style='color:#FFF;'></i>" +obj1[0][r].State+","+obj1[0][r].district+"</h4>";
     ...
     opt +="<div class='col-sm-4'><dl><dt><i class='fa fa-university' style='color:#004884;'></i> Franchise Id</dt><dd>"+obj1[0][r].fran_id+"</dd></dl>";
     opt +="<dl class='margin-sm-bottom'><dt><i class='fa fa-university' style='color:#004884;'></i> Franchisee Name</dt><dd>"+obj1[0][r].institute_name+"</dd></dl></div>";
     opt +="<div class='col-sm-4'><dl><dt><i class=\"fa fa-user\" style='color:#004884;'></i> Ownwer Name</dt><dd>"+obj1[0][r].fname+"</dd></dl>";
     opt +="<dl class='margin-sm-bottom'><dt><i class=\"fa fa-envelope-o\" style='color:#004884;'></i> Email Id</dt><dd>"+obj1[0][r].femail+"</dd></dl></div>";                              
     opt +="<div class='col-sm-4'><dl><dt><i class=\"fa fa-mobile\" style='color:#004884; font-size:20px;'></i> Contact No</dt><dd>"+obj1[0][r].cus_mobile+"</dd></dl>";
     opt +="<dl class='margin-sm-bottom'><dt><i class=\"fa fa-map-marker\" style='color:#004884;'></i> Address</dt><dd>"+obj1[0][r].address+"</dd></dl></div>";
     opt +="</div>";
    
     opt +="<div class='panel-body'>"; 
     opt +="<div class='col-sm-4'><dl><dt><i class=\"fa fa-globe\" style='color:#004884;'></i> State</dt><dd>"+obj1[0][r].State+"</dd></dl>";
     opt +="<dl class='margin-sm-bottom'><dt><i class=\"fa fa-map-marker\" style='color:#004884;'></i> Pincode</dt><dd>"+obj1[0][r].pincode+"</dd></dl></div>";
     opt +="<div class='col-sm-4'><dl><dt><i class=\"fa fa-globe\" style='color:#004884;'></i> City</dt><dd>"+obj1[0][r].City+"</dd></dl>";
     opt +="<dl class='margin-sm-bottom'><dt><i class=\"fa fa-calendar\" style='color:#004884;'></i> Register Date</dt><dd>"+dts1+"</dd></dl></div>";
     opt +="<div class='col-sm-4'><dl><dt><i class=\"fa fa-globe\" style='color:#004884;'></i> District</dt><dd>"+obj1[0][r].district+"</dd></dl>";
     opt +="<dl class='margin-sm-bottom'><dt><i class=\"fa fa-star-o\" style='color:#004884'></i> Status</dt><dd>"+stat+"</dd></dl></div>";
     opt +="</div>";

	 opt +="<div class='panel-body'>"; 
     opt +="<div class='col-sm-4'><dl><dt><i style=\"color:#004884;\" class=\"fa fa-user\"></i> Username</dt><dd>"+obj1[0][r].email+"</dd></dl></div>";     
     opt +="<div class='col-sm-4'><dl><dt><i style=\"color:#004884;\" class=\"fa fa-unlock\"></i> Password</dt><dd>"+obj1[0][r].password+"</dd></dl></div>";
     opt +="</div>";
 ...
 <div class="container-fluid-md">
     <div class="row">
        <div class="col-md-12">
            ...
            <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
             ...
             <div class="col-sm-3 pull-right" style="margin-top:0px;margin-bottom:-29px">
                 ...
                 <td><input type="checkbox" id="<?php echo $row->cus_id; ?>" onchange="eachcheck(this,'subtitle');"  /></td>
    					   ...
    					   <td title="<?php echo $row->cus_mobile; ?>"><?php echo $row->cus_mobile; ?></td>
    					   <td title="<?php echo $row->femail; ?>"><?php echo $row->femail; ?></td>
    					   <td title="<?php echo $row->State; ?>"><?php echo $row->State; ?></td>
    					   <td title="<?php echo $row->district; ?>"><?php echo $row->district; ?></td>
                 <td style="display">
                  <?php $rdt=$row->date;
                        $farr1=array();
                        $farr1 =explode("-",$rdt); 
                 ...
                 <td>
                     <select name="stat" id="stat" onchange="change_status(this.value,'<?php echo $row->cus_id; ?>')">
          			 ...
          			 <td  style="text-align:center"><i id="sign" style="font-size:20px; margin-right:2px;" onclick="open_popup(jArray,<?php echo $row->cus_id; ?>)" class="fa fa-info-circle"></i><i style="color:#275273;font-size:20px;margin-right:2px;" id="EditB2" onclick="send_crdi('<?php echo $row->femail; ?>','<?php echo $row->cus_id; ?>');" class="fa fa-envelope-o" title="Send Credintials"></i><a href="javascript:void(0);" onclick="getsinglepdf('<?php echo $id=$row->cus_id; ?>')" title="Download Pdf"><i style="color:#FF3500;font-size:20px;" id="pdf"  class="fa fa-file-pdf-o"></i><a href="#" onclick="getsingleExcel('<?php echo $id=$row->cus_id; ?>','<?php echo $id=$row->institute_name; ?>')" Title="Download Excel"><i style="color:#275273;font-size:20px;" onclick="" class="fa fa-file-excel-o"></i></a><i style="color:#275273;font-size:20px;margin-left:3px;" id="EditB" onclick="Edit(jArray,<?php echo $row->cus_id; ?>);" class="fa fa-edit" title="Edit Record"></i><i style="color:#275273;font-size:20px; margin-left:3px;" id="DeleteN" onclick="Delete(<?php echo $row->cus_id; ?>);" class="fa fa-trash-o" title="Delete Record"></i></td>
             ...
             <?php }?>
			   ...
			   <form id="pfield" action="<?php echo base_url(); ?>index.php/Admin_Franch/get_enquiry_pdf" method="post">
			   ...
			   <form id="efield" action="<?php echo base_url(); ?>index.php/Admin_Franch/get_enquiry_excel" method="post">
                    <input type="hidden" name="from1" id='from1' value="" />
                    <input type="hidden" name="to1" id='to1' value="" />
                    <input type="hidden" name="stt1" id='st1' value="" />
            ...
            <div class="form-group">
                            <label class="col-sm-4 control-label" for="inputLastName3">Select Type<span class="asterisk">*</span></label>
                            <div class="col-sm-8">
