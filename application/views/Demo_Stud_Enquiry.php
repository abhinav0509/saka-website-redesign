     ...
     j("#rmd").click(function(){
      ...
      remark=j("#msg").val();
       j.ajax({  
            ...
            url: '<?php echo base_url(); ?>index.php/DemoLogin/Admin_Remark',
			type: "POST",
              ...
              source: function (request, response) {
                  j.ajax({
                      ...
                      contentType: "application/json; charset=utf-8",
                        url: "<?php echo base_url(); ?>index.php/DemoLogin/GetFranData1",
       ...
       j("#state2").autocomplete({
              source: function (request, response) {
                  j.ajax({
                      type: "POST",
                      contentType: "application/json; charset=utf-8",
                        url: "<?php echo base_url(); ?>index.php/DemoLogin/GetFranData2",
...
function Download_Excel(id,name)
 {
    ...
    window.location="<?php echo base_url(); ?>index.php/DemoLogin/get_single_enquiry_excel?id="+id+"&"+"name="+name;
 }
 function Download_pdf(id)
 {
   
    window.location="<?php echo base_url(); ?>index.php/DemoLogin/get_single_enquiry_pdf?id="+id;
 }
 function Download_Excel_all()
 {
     j("#from1").val(j("#pcont1").val());
    j("#to1").val(j('#pcont').val());
    j("#fn1").val(j('#state2').val());
	j("#cn1").val(j('#state1').val());
	j("#storedArrayvalue1").val(j("#storeArrayvalue").val());
	j("#efield").submit();
    //window.location="<?php echo base_url(); ?>index.php/DemoLogin/get_excel_by_cat?fdate="+fdate+"&"+"todate="+todate+"&"+"fnm="+fnm
 }
 function Download_pdf_all()
 {
     j("#from").val(j("#pcont1").val());
    j("#to").val(j('#pcont').val());
    j("#fn").val(j('#state2').val());
	j("#cn").val(j('#state1').val());
	j("#storedArrayvalue").val(j("#storeArrayvalue").val());
	j("#pfield").submit();
    //window.location="<?php echo base_url(); ?>index.php/DemoLogin/get_pdf_by_cat?fdate="+fdate+"&"+"todate="+todate+"&"+"fnm="+fnm
 }
...
<div class="container-fluid-md">
     <div class="row">
        ...
        <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
          ...
          <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
            ...
            <tbody id="tdata" style="font-size:12px;">
                  ...
                  <td><a href="javascript:void(0);"><i class="fa fa-floppy-o" onclick="open_popup(this,'<?php echo $row->id; ?>')" style="margin-left:10px;font-size:20px;"></i></a></td>
        ...
        <form id="hfield" action="<?php echo base_url(); ?>index.php/Admin/Demo_Active_Fran" method="post">
		...
		<form id="pfield" action="<?php echo base_url(); ?>index.php/DemoLogin/get_pdf_by_cat" method="post">
		...
		<form id="efield" action="<?php echo base_url(); ?>index.php/DemoLogin/get_excel_by_cat" method="post">
					<input type="hidden" name="from1" id='from1' value="" />
                    <input type="hidden" name="to1" id='to1' value="" />
                    <input type="hidden" name="fn1" id='fn1' value="" />
                    <input type="hidden" name="cn1" id='cn1' value="" />
