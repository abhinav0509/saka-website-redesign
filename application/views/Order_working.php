...
function abc(obj1,id1)
{
  ...
  j("#arem").click(function(){
        
      remark=j("#rem").val();
      //alert("id="+id1+"Rem="+remark);
       j.ajax({  
            url: '<?php echo base_url(); ?>index.php/Order_management/Add_Remark',
            type: 'POST',
           data:{'remark':remark,'id':id1},
...
function open_mult_popup()
{
  ...
  j("#arem").click(function(){
    ...
    if(t!="")
    {
      ...
      //alert("id="+id1+"Rem="+remark);
       j.ajax({  
            url: '<?php echo base_url(); ?>index.php/Order_management/Add_mult_Remark',
            type: 'POST',
           data:{'remark':remark,'id':t},
...
function clickAction(obj) {
    ...
    if(t!="")
    {
      ...
      //alert("id="+id1+"Rem="+remark);
       j.ajax({  
            url: '<?php echo base_url(); ?>index.php/Order_management/ord_state_Remark',
            type: 'POST',
           data:{'id':t},
     ...
     <div class="row">
        ...
        <div class="">
          ...
          <div class="col-md-12" style="margin-bottom:36px;">
            ...
            <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
                <input type="text" id="fran" name="fran" class="form-control" placeholder="Search By Franchise" required/>
            </div>
            <div class="col-sm-2" style="margin-top:0px;margin-bottom:-29px">
           ...
           <div class="table-responsive">
                    <table class="table">
                      <thead>
                        <tr style="background-color:#d7dadc;">
                         ...
                         <!--           <li><a href="javascript:;" onclick="clickpoup('All')">All</a></li>
                                    ...
                                    <li class="divider"></li>
                                    <li ><a href="javascript:;" onclick="clickAction('Dispatch')">
                                        <i class="fa fa-fw fa-caret-right"></i>Dispatch
                                        <span class="label label-danger pull-right">0</span></a>
                                    </li>
                                    <li><a href="javascript:;" onclick="open_mult_popup()">
                                        <i class="fa fa-fw fa-caret-right"></i>Remark
                                        <span class="label label-danger pull-right">0</span></a>
                                    </li>
                                </ul>
                            </span> 
                      ...
                      <tbody id="tdata" style="font-size:12px;">
                          ...
                          <tr>
                            <td><input type="checkbox" id="<?php echo $ord->O_Id; ?>" onchange="eachcheck(this,'subtitle');"  /></td>
                          <td>
                          ...
                          <td title="<?php echo $ord->stud_name; ?>"><?php echo $ord->stud_name; ?></td>
                          <td title="<?php echo $ord->course_name; ?>"><?php echo $ord->course_name; ?></td>
                          <td title="<?php echo $ord->Quanitity; ?>"><?php echo $ord->Quanitity; ?></td>
                          <td title="<?php echo $ord->price; ?>"><?php echo $ord->price; ?></td>
                          <td>
                          ...
                          <td><?php $rem=$ord->Admin_Remark; if($rem==""){echo $rem="No Remark";}else{echo $rem;} ?></td>
                          <td>                  
                           <i class="fa fa-floppy-o" id="signe"  onClick="abc(this,'<?php echo $ord->O_Id; ?>')" style="margin-left:10px;font-size:20px;color:#357ebd;margin-right:10px;" title="Add Remark"></i>
                           <i id="sign" style="font-size:20px; margin-right:0px;" onclick="open_popup(jArray,'<?php echo $ord->O_Id; ?>')" class="fa fa-info-circle"></i><!--<a href="javascript:void(0);" onclick="get_order_det_admin('<?php echo $ord->o_date; ?>','<?php echo $ord->f_id; ?>')" title="View Detailed Order"><i class="fa fa-credit-card" style="font-size:20px;"></i></a>-->
                         ...
                         <div class="row">            
                             ...
                             <div class="col-lg-6" style="background-color:#FFF;">               
                                         ...
                                         <div id="LogIn"  class="panel-collapse collapse in" style="border-top: 0px;">
                                                     ...
                                                     <form method="post" id="loginSubmitbtn" action="#">
                                                     ...
                                                     <div class="row">
                                                         <div class="col-lg-12 form-group">                                    
                                                             <button class="btn btn-primary btn-block login-social" id="arem" type="button">Save Remark</button>                                    
                                                         </div>
                                                     </div>
                                                     </form>
